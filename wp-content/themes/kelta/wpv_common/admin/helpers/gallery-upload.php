...
function gallery_image_form_url($form_action_url, $type){
	return $form_action_url.'&gallery_image_upload=1';
}
...
function gallery_image_attachment_fields_to_edit($form_fields, $post){
	...
	$form_fields['buttons'] = array( 
		'tr' => "\t\t<tr><td></td><td><input type='button' class='button' onclick='wpv_gallery_add(".$post->ID.")' value='" . esc_attr__('Insert into Gallery', 'wpv') . "' /> $delete</td></tr>\n"
	);
	return $form_fields;
}
