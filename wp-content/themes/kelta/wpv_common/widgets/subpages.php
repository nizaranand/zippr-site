...
class wpv_subpages extends WP_Widget {
	...
	public function wpv_subpages() {
		$widget_ops = array(
			...
			'description' => __('Displays a list of SubPages', 'wpv')
		);
		$this->WP_Widget('wpv_subpages', __('Vamtam - List subpages', 'wpv') , $widget_ops);
	}
	...
	function widget($args, $instance) {
		...
		require WPV_WIDGETS_TPL . 'subpages-widget.php';
	}
	...
	function form($instance) {
		...
		require WPV_WIDGETS_TPL . 'subpages-config.php';
	}
}
