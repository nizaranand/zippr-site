...
class wpv_posts extends WP_Widget {
	...
	public function widget($args, $instance) {
		...
		$twitter_query = $instance['twitter_query'];
	...
	public function update($new_instance, $old_instance) {
		...
		$instance['twitter_query'] = $new_instance['twitter_query'];
	...
	private function get_section_title($orderby) {
		...
		if($orderby == 'tweets')
			return apply_filters('wpv_multiwidget_tab_title', __('Tweets', 'wpv'), $orderby);
		if($orderby == 'tags')
	...
	public function form($instance) {
		...
		$twitter_user = isset($instance['twitter_user']) ? $instance['twitter_user'] : '';
		$twitter_query = isset($instance['twitter_query']) ? $instance['twitter_query'] : '';
