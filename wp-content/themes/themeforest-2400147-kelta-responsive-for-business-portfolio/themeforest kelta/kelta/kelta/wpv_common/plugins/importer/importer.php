<?php
/*
Plugin Name: WPV Importer
Description: Import posts, pages, comments, custom fields, categories, tags and more from a WordPress export file. Based on the WordPress Importer by wordpress.org
...
class WPV_Import extends WP_Importer {
	...
	function import_end() {
		...
		if($this->one_click) {
			...
			$quick_setup = admin_url('admin.php?page=wpv_quick_setup');
